...
{
	if (region.bc.ag === region.br.ag)
	{
		return 'on line ' + region.bc.ag;
	}
	return 'on lines ' + region.bc.ag + ' through ' + region.br.ag;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bu: fragment, by: host, bM: path, bO: port_, bR: protocol, bS: query};
	});
...
var $author$project$Main$Model = F5(
	function (theme, viewportHeight, typewriterStatus, typewriterSpeed, deviceClass) {
		return {G: deviceClass, x: theme, aa: typewriterSpeed, m: typewriterStatus, aP: viewportHeight};
	});
...
var $mdgriffith$elm_ui$Element$classifyDevice = function (window) {
	return {
		aX: function () {
			var shortSide = A2($elm$core$Basics$min, window.bf, window.a_);
			var longSide = A2($elm$core$Basics$max, window.bf, window.a_);
			return (shortSide < 600) ? 0 : ((longSide <= 1200) ? 1 : (((longSide > 1200) && (longSide <= 1920)) ? 2 : 3));
		}(),
		bJ: (_Utils_cmp(window.bf, window.a_) < 0) ? 0 : 1
	};
};
...
var $author$project$Theme$light = {
	ae: A3($mdgriffith$elm_ui$Element$rgb255, 222, 225, 221),
	bB: A3($mdgriffith$elm_ui$Element$rgb255, 47, 87, 93),
	a8: A3($mdgriffith$elm_ui$Element$rgb255, 101, 139, 111),
	dj: A3($mdgriffith$elm_ui$Element$rgb255, 109, 145, 151),
	be: A3($mdgriffith$elm_ui$Element$rgb255, 40, 54, 61),
	dO: A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255)
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$json$Json$Encode$bool = _Json_wrap;
var $author$project$Main$toggleScrollLock = _Platform_outgoingPort('toggleScrollLock', $elm$json$Json$Encode$bool);
...
var $author$project$Main$typewrittenTexts = _List_fromArray(
	[
		_List_fromArray(
		[
			$author$project$Main$Text('Hello there!')
		]),
		_List_fromArray(
		[
			$author$project$Main$Text('My name is Sergei Knyazev. I am a passionate frontend developer who loves delivering top-quality web applications and takes pride in his work.')
		]),
		_List_fromArray(
		[
			$author$project$Main$Text('I primarily work in React and Typescript, but outside of my full-time job I love using functional languages with sound type systems, such as Elm or Haskell. In fact, this very website has been '),
			A2($author$project$Main$Link, 'https://github.com/Jeaciaz/portfolio', 'written in Elm!')
		])
	]);
var $author$project$Main$init = function (_v0) {
	var innerHeight = _v0.a1;
	var innerWidth = _v0.a2;
	var isVisited = _v0.a3;
	return isVisited ? _Utils_Tuple2(
		A5(
			$author$project$Main$Model,
			$author$project$Theme$light,
			innerHeight,
			$author$project$Main$Complete($author$project$Main$typewrittenTexts),
			0,
			$mdgriffith$elm_ui$Element$classifyDevice(
				{a_: innerHeight, bf: innerWidth}).aX),
		...
		A5(
			...
			$author$project$Main$Incomplete(
				A2(
					$elm$core$List$map,
					function (p) {
						return _Utils_Tuple2(0, p);
					},
					$author$project$Main$typewrittenTexts)),
			0,
			$mdgriffith$elm_ui$Element$classifyDevice(
				{a_: innerHeight, bf: innerWidth}).aX),
		$author$project$Main$toggleScrollLock(true));
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$Main$SpeedUp = {$: 1};
var $author$project$Main$TypewriterTick = {$: 0};
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {bQ: processes, bZ: taggers};
	});
						...
						return $elm$core$Platform$Sub$batch(
							_List_fromArray(
								[
									...
									speedInMs,
									function (_v1) {
										return $author$project$Main$TypewriterTick;
									}),
									$elm$browser$Browser$Events$onKeyPress(
									$elm$json$Json$Decode$succeed($author$project$Main$SpeedUp))
								]));
					case 1:
...
var $author$project$Main$AwaitingKeypress = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$Fast = 1;
var $author$project$Main$Fastest = 2;
...
var $author$project$Main$typewriterBlockLength = function (frag) {
	if (!frag.$) {
		var str = frag.b;
...
var $author$project$Main$typewriterBlockListLength = A2(
	$elm$core$List$foldl,
	A2($elm$core$Basics$composeR, $author$project$Main$typewriterBlockLength, $elm$core$Basics$add),
	0);
var $elm$core$Tuple$second = function (_v0) {
	var y = _v0.b;
	return y;
};
var $author$project$Main$unwrapFragments = $elm$core$List$map($elm$core$Tuple$second);
		...
		switch (msg.$) {
				...
				if (!_v1.$) {
					...
					var _v2 = A2(
						...
						function (_v3) {
							...
							return _Utils_cmp(
								len,
								$author$project$Main$typewriterBlockListLength(p)) > -1;
						},
						fragments);
					var completed = _v2.a;
					var uncompleted = _v2.b;
					var updatedUncompleted = function () {
						if (!uncompleted.b) {
							return _List_Nil;
						} else {
							var _v7 = uncompleted.a;
							var len = _v7.a;
							var str = _v7.b;
							var tail = uncompleted.b;
							return A2(
								$elm$core$List$cons,
								_Utils_Tuple2(len + 1, str),
								tail);
						}
					}();
					var isDone = function () {
						if (!updatedUncompleted.b) {
							return true;
						} else {
							if (!updatedUncompleted.b.b) {
								var _v5 = updatedUncompleted.a;
								var len = _v5.a;
								var p = _v5.b;
								return _Utils_eq(
									len,
									$author$project$Main$typewriterBlockListLength(p));
							} else {
								return false;
							}
						}
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								m: isDone ? $author$project$Main$AwaitingKeypress(
									$author$project$Main$unwrapFragments(
										_Utils_ap(completed, updatedUncompleted))) : $author$project$Main$Incomplete(
									_Utils_ap(completed, updatedUncompleted))
							}),
			...
			case 1:
				var newModel = function () {
					var _v9 = _Utils_Tuple2(model.m, model.aa);
					_v9$0:
					while (true) {
						switch (_v9.b) {
							case 0:
									...
									return _Utils_update(
										model,
										{
											m: function () {
												...
												switch (_v13.$) {
													case 0:
														var fragmentList = _v13.a;
														return $author$project$Main$AwaitingKeypress(
															$author$project$Main$unwrapFragments(fragmentList));
													case 1:
														var blocks = _v13.a;
														return $author$project$Main$Complete(blocks);
													default:
														var blocks = _v13.a;
														return $author$project$Main$Complete(blocks);
												}
					...
					return _Utils_update(
						model,
						{
							m: $author$project$Main$Complete(texts)
						});
				}();
				return _Utils_Tuple2(
					newModel,
					function () {
						...
						if (_v8.$ === 2) {
							return $elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										$author$project$Main$scrollToID($author$project$Main$recentWorkId),
										$author$project$Main$setVisited(0),
										$author$project$Main$toggleScrollLock(false)
									]));
						} else {
			...
			default:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							G: $mdgriffith$elm_ui$Element$classifyDevice(
								{a_: newHeight, bf: newWidth}).aX,
							aP: newHeight
						}),
					$elm$core$Platform$Cmd$none);
		}
...
var $author$project$Main$cards = _List_fromArray(
	[
		{
...
var $mdgriffith$elm_ui$Internal$Style$classes = {b5: 'a', aT: 'atv', b7: 'ab', b8: 'cx', b9: 'cy', ca: 'acb', cb: 'accx', cc: 'accy', cd: 'acr', bk: 'al', bl: 'ar', ce: 'at', aU: 'ah', aV: 'av', ch: 's', cl: 'bh', cm: 'b', cp: 'w7', cr: 'bd', cs: 'bdt', an: 'bn', ct: 'bs', ap: 'cpe', cy: 'cp', cz: 'cpx', cA: 'cpy', E: 'c', ar: 'ctr', as: 'cb', at: 'ccx', F: 'ccy', af: 'cl', au: 'cr', cD: 'ct', cE: 'cptr', cF: 'ctxt', cM: 'fcs', bt: 'focus-within', cN: 'fs', cO: 'g', aZ: 'hbh', a$: 'hc', bw: 'he', a0: 'hf', bx: 'hfp', cQ: 'hv', cR: 'ic', cT: 'fr', aA: 'lbl', cV: 'iml', cW: 'imlf', cX: 'imlp', cY: 'implw', cZ: 'it', c_: 'i', bF: 'lnk', Z: 'nb', bI: 'notxt', c3: 'ol', c5: 'or', R: 'oq', da: 'oh', bK: 'pg', bL: 'p', db: 'ppe', dd: 'ui', u: 'r', df: 'sb', dg: 'sbx', dh: 'sby', di: 'sbt', dl: 'e', dn: 'cap', $7: 'sev', ds: 'sk', be: 't', dv: 'tc', dw: 'w8', dx: 'w2', dy: 'w9', dz: 'tj', aK: 'tja', dA: 'tl', dB: 'w3', dC: 'w5', dD: 'w4', dE: 'tr', dF: 'w6', dG: 'w1', dH: 'tun', b_: 'ts', U: 'clr', dL: 'u', bg: 'wc', b2: 'we', bh: 'wf', b3: 'wfp', bi: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bK);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bL);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.u);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dl);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.y)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dp.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.dp.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.u) + ('-' + ($elm$core$String$fromInt(pos.cB) + ('-' + ($elm$core$String$fromInt(pos.bf) + ('-' + $elm$core$String$fromInt(pos.a_)))))));
		case 11:
	...
	[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aT, $mdgriffith$elm_ui$Internal$Style$classes.U)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ch) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ch) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ch) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.u) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ch) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.ar) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$inputTextReset + ($mdgriffith$elm_ui$Internal$Style$sliderReset + ($mdgriffith$elm_ui$Internal$Style$trackReset + ($mdgriffith$elm_ui$Internal$Style$thumbReset + $mdgriffith$elm_ui$Internal$Style$explainer)))))))))))))));
		...
		switch (rule.$) {
			...
			case 9:
				...
				var modernPosition = A2(
					...
					_List_fromArray(
						[
							'grid-row: ' + ($elm$core$String$fromInt(position.u) + (' / ' + ($elm$core$String$fromInt(position.u + position.a_) + ';'))),
							'grid-column: ' + ($elm$core$String$fromInt(position.cB) + (' / ' + ($elm$core$String$fromInt(position.cB + position.bf) + ';')))
						]));
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.u) + ('-' + ($elm$core$String$fromInt(position.cB) + ('-' + ($elm$core$String$fromInt(position.bf) + ('-' + $elm$core$String$fromInt(position.a_)))))));
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.dn + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.be + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.dn + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.be)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a_: height / size, dm: size, b0: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.cw, adjustment.ck, adjustment.cG, adjustment.c$]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dl))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ch, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.F, $mdgriffith$elm_ui$Internal$Style$classes.cd])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ch, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.F, $mdgriffith$elm_ui$Internal$Style$classes.cb])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ch, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.cc])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.ch, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.ar, $mdgriffith$elm_ui$Internal$Style$classes.ca])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
...
var $mdgriffith$elm_ui$Internal$Model$textElementClasses = $mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.be + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a$)))));
...
var $mdgriffith$elm_ui$Internal$Model$textElementFillClasses = $mdgriffith$elm_ui$Internal$Style$classes.ch + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.be + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.bh + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a0)))));
					...
					case 1:
						...
						return _Utils_eq(context, $mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.bz, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.b5]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.cm]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.c5]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.c3]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.cT]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.Z, $mdgriffith$elm_ui$Internal$Style$classes.dl, $mdgriffith$elm_ui$Internal$Style$classes.cl]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.bz, $mdgriffith$elm_ui$Internal$Model$NoStyleSheet, $mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.aU + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.b8);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						A3(
						$mdgriffith$elm_ui$Internal$Model$Single,
						$mdgriffith$elm_ui$Internal$Style$classes.ch + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.u + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
...
var $author$project$Theme$ifMobileThenElse = F3(
	function (valueThen, valueElse, deviceClass) {
		return A2(
			$elm$core$List$member,
			deviceClass,
			_List_fromArray(
				[0, 1])) ? valueThen : valueElse;
	});
var $author$project$Theme$fontSizeText = A2($author$project$Theme$ifMobileThenElse, 16, 20);
...
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{cM: $elm$core$Maybe$Nothing, cQ: $elm$core$Maybe$Nothing, c0: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.dd, $mdgriffith$elm_ui$Internal$Style$classes.ch, $mdgriffith$elm_ui$Internal$Style$classes.dl]))),
...
var $mdgriffith$elm_ui$Element$fromRgb = function (clr) {
	return A4($mdgriffith$elm_ui$Internal$Model$Rgba, clr.a9, clr.aY, clr.aW, clr.cf);
};
var $mdgriffith$elm_ui$Element$toRgb = function (_v0) {
	...
	var b = _v0.c;
	var a = _v0.d;
	return {cf: a, aW: b, aY: g, a9: r};
};
var $author$project$Theme$addOpacity = function (opacity) {
	return A2(
...
var $author$project$Theme$fontSizeH3 = A2($author$project$Theme$ifMobileThenElse, 20, 24);
					...
					A2(
						...
						A2(
							...
							A2(
								...
								A2(
									$elm$core$List$cons,
									$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.at + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.F + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bF)))),
									attrs)))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
	...
	return $elm$core$String$concat(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.dm) + 'px',
				$mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.cC)
			]));
};
var $mdgriffith$elm_ui$Internal$Flag$shadows = $mdgriffith$elm_ui$Internal$Flag$flag(19);
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {cn: almostShade.cn, cC: almostShade.cC, bD: false, c2: almostShade.c2, dm: almostShade.dm};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $andrewMacmurray$elm_simple_animation$Simple$Transition$color = $andrewMacmurray$elm_simple_animation$Simple$Transition$property('color');
...
var $andrewMacmurray$elm_simple_animation$Internal$Transition$all = function (config) {
	return A2(
		$elm$core$Basics$composeR,
		$elm$core$List$map(
			function (p) {
				return A2(p, config.cI, config.c9);
			}),
		$elm$core$Basics$identity);
};
...
var $andrewMacmurray$elm_simple_animation$Simple$Transition$all = function (config) {
	return A2(
		$elm$core$Basics$composeR,
		$andrewMacmurray$elm_simple_animation$Internal$Transition$all(config),
		$andrewMacmurray$elm_simple_animation$Internal$Transition$toAttr);
};
var $andrewMacmurray$elm_simple_animation$Internal$Ease$EaseInOut = {$: 5};
...
var $author$project$Main$transition = A2(
	$elm$core$Basics$composeR,
	$andrewMacmurray$elm_simple_animation$Simple$Transition$all(
		{
			cI: 100,
			c9: _List_fromArray(
...
var $author$project$Main$viewLink = F3(
	function (colorIdle, colorHovered, label) {
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$color(colorIdle),
					$mdgriffith$elm_ui$Element$mouseOver(
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$color(colorHovered)
						])),
					$author$project$Main$transition(
					_List_fromArray(
						[$andrewMacmurray$elm_simple_animation$Simple$Transition$color]))
				]),
...
var $author$project$Main$viewCard = F2(
	function (_v0, _v1) {
		var theme = _v0.x;
		var deviceClass = _v0.G;
		var title = _v1.aM;
		var href = _v1.az;
		var githubHref = _v1.ax;
		var desc = _v1.aw;
		var techStack = _v1.aJ;
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$Background$color(theme.dO),
						$mdgriffith$elm_ui$Element$Border$rounded(8),
						$mdgriffith$elm_ui$Element$Border$shadow(
						{
							cn: 4.0,
							cC: A2($author$project$Theme$addOpacity, 0.5, theme.be),
							c2: _Utils_Tuple2(2.0, 2.0),
							dm: 1.0
						})
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								...
								{ao: 12, aC: 24, aD: 24, aN: 24}),
								$mdgriffith$elm_ui$Element$Border$widthEach(
								{ao: 1, aC: 0, aD: 0, aN: 0}),
								$mdgriffith$elm_ui$Element$Border$color(theme.ae)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$author$project$Theme$fontSizeH3(deviceClass)),
										$mdgriffith$elm_ui$Element$Font$semiBold,
										$author$project$Main$montserrat
									]),
								{
									aB: A3($author$project$Main$viewLink, theme.bB, theme.dj, title),
									aO: href
								}),
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$paddingEach(
								{ao: 24, aC: 24, aD: 24, aN: 12})
							]),
						A2(
							$elm$core$List$map,
							function (techStackEntry) {
								return A2(
									$mdgriffith$elm_ui$Element$paragraph,
									_List_Nil,
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('➤ ' + techStackEntry)
										]));
							},
							techStack))
					])));
	});
var $author$project$Theme$fontSizeH2 = A2($author$project$Theme$ifMobileThenElse, 24, 30);
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.af + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.F + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bi)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
				...
				_List_Nil,
				{
					aB: A2(
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$height(
								$mdgriffith$elm_ui$Element$px(largeFontSize))
							]),
						{bq: description, bX: src}),
					aO: url
				});
		});
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Background$color(theme.a8),
				$mdgriffith$elm_ui$Element$Font$color(theme.ae)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text('If you want to see something done by me or wish to cooperate in other ways,')
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Font$size(
								$author$project$Theme$fontSizeH2(deviceClass))
							]),
						$mdgriffith$elm_ui$Element$text('Contact me via: ')),
						A2(
...
var $author$project$Main$viewH2 = function (_v0) {
	var deviceClass = _v0.G;
...
var $author$project$Util$mapAcc = F3(
	function (f, acc0, list) {
		if (!list.b) {
			return _Utils_Tuple2(_List_Nil, acc0);
		} else {
			var x = list.a;
			var xs = list.b;
			var _v1 = A2(f, x, acc0);
			var y = _v1.a;
			var acc1 = _v1.b;
			var _v2 = A3($author$project$Util$mapAcc, f, acc1, xs);
			var ys = _v2.a;
			var acc2 = _v2.b;
			return _Utils_Tuple2(
...
var $author$project$Main$cutTypewriterFragment = function (_v0) {
	var limit = _v0.a;
	var frags = _v0.b;
	return A3(
		$author$project$Util$mapAcc,
		F2(
			function (frag, acc) {
				if (frag.$ === 1) {
					var t = frag.a;
					return _Utils_Tuple2(
						$author$project$Main$Text(
							A2($elm$core$String$left, acc, t)),
						A2(
							$elm$core$Basics$max,
							0,
							acc - $elm$core$String$length(t)));
				} else {
					var href = frag.a;
					var t = frag.b;
					return _Utils_Tuple2(
...
var $author$project$Main$viewCaret = function (_v0) {
	var theme = _v0.x;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color(theme.ae),
...
var $author$project$Main$viewTypewriterFragment = F2(
	function (_v0, frag) {
		var theme = _v0.x;
		if (frag.$ === 1) {
			var t = frag.a;
			...
			return A2(
				...
				_List_Nil,
				{
					aB: A3($author$project$Main$viewLink, theme.bB, theme.be, t),
					aO: href
				});
		}
	});
		...
		_Utils_ap(
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
					$mdgriffith$elm_ui$Element$height(
					$mdgriffith$elm_ui$Element$px(model.aP)),
					$mdgriffith$elm_ui$Element$centerX,
					$mdgriffith$elm_ui$Element$padding(24),
					$mdgriffith$elm_ui$Element$Font$color(model.x.ae),
					...
					$mdgriffith$elm_ui$Element$Background$color(model.x.a8)
				]),
			function () {
				var _v0 = model.m;
				if (_v0.$ === 2) {
					...
					return _List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Events$onClick($author$project$Main$SpeedUp)
						]);
				}
			}()),
		_List_fromArray(
						...
						switch (_v4.$) {
							case 0:
								...
								return A2(
									$elm$core$List$filterMap,
									function (frag) {
										return (!(!frag.a)) ? $elm$core$Maybe$Just(
											_Utils_Tuple2(
												_Utils_cmp(
													frag.a,
													$author$project$Main$typewriterBlockListLength(frag.b)) < 0,
												$author$project$Main$cutTypewriterFragment(frag))) : $elm$core$Maybe$Nothing;
									},
									frags);
							case 1:
								var blocks = _v4.a;
								return A2(
									$elm$core$List$map,
									function (block) {
										return _Utils_Tuple2(false, block);
									},
									blocks);
							default:
								var blocks = _v4.a;
							...
							function (_v1) {
								...
								return A2(
									...
									_Utils_ap(
										A2(
											$elm$core$List$map,
											$author$project$Main$viewTypewriterFragment(model),
											block),
										_List_fromArray(
											[
												shouldViewCaret ? $author$project$Main$viewCaret(model) : $mdgriffith$elm_ui$Element$none
											])));
							},
							visibleBlocks),
						_List_fromArray(
									...
									switch (_v2.$) {
										case 0:
											return _List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text(
													'Press any key to ' + function () {
														var _v3 = model.aa;
														switch (_v3) {
															case 0:
																return 'speed up';
															case 1:
																return 'speed up again';
															default:
																return 'skip';
														}
													}()),
													$author$project$Main$viewCaret(model)
												]);
										case 1:
											return _List_fromArray(
												[
													$mdgriffith$elm_ui$Element$text('Press any key to continue'),
													$author$project$Main$viewCaret(model)
												]);
										default:
											return _List_Nil;
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$montserrat,
				$mdgriffith$elm_ui$Element$Font$size(
				$author$project$Theme$fontSizeText(model.G)),
				$mdgriffith$elm_ui$Element$Background$color(model.x.ae),
				$mdgriffith$elm_ui$Element$Font$color(model.x.be)
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_Utils_ap(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$htmlAttribute(
							$elm$html$Html$Attributes$id($author$project$Main$recentWorkId)),
							$mdgriffith$elm_ui$Element$height(
							(!model.G) ? $mdgriffith$elm_ui$Element$fill : A2($mdgriffith$elm_ui$Element$minimum, model.aP, $mdgriffith$elm_ui$Element$fill)),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$Font$color(model.x.a8),
											$mdgriffith$elm_ui$Element$centerX
										]),
									A2(
										$author$project$Main$viewH2,
										model,
										$mdgriffith$elm_ui$Element$text('My recent work'))),
									A2(
									$mdgriffith$elm_ui$Element$paragraph,
									_List_Nil,
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$text('My GitHub doesn’t have much activity due to my work being mostly on my day job. These are things I made in my free time that I don’t consider obsolete.')
										]))
								])),
							A2(
							$mdgriffith$elm_ui$Element$wrappedRow,
							...
							A2(
								...
								$author$project$Main$cards)),
							$author$project$Main$viewFooter(model)
						]))
				])));
};
var $author$project$Main$main = $elm$browser$Browser$element(
	{cU: $author$project$Main$init, du: $author$project$Main$subscriptions, dM: $author$project$Main$update, dN: $author$project$Main$view});
/*
					...
					return A2(
						...
						function (innerHeight) {
							return $elm$json$Json$Decode$succeed(
								{a1: innerHeight, a2: innerWidth, a3: isVisited});
						},
						A2($elm$json$Json$Decode$field, 'innerHeight', $elm$json$Json$Decode$int));
				},
				A2($elm$json$Json$Decode$field, 'innerWidth', $elm$json$Json$Decode$int));
		},
		A2($elm$json$Json$Decode$field, 'isVisited', $elm$json$Json$Decode$bool)))(0)}});}(this));
*/
export const Elm = {'Main':{'init':$author$project$Main$main(
	A2(
		...
		A2($elm$json$Json$Decode$field, 'isVisited', $elm$json$Json$Decode$bool)))(0)}};
export default Elm;
